...
void loop() {
  digitalWrite(13,HIGH);     // Changing the state of the led H->L alternatively
  delay(1000);               // Delay for 1sec
  digitalWrite(13,LOW);      // Changing the state of the led L->H alternatively
  delay(1000);               // Delay for 1sec
}
